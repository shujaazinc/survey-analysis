...
variables <- c("T_F1_1", "T_F1_2", "T_F1_3", "T_F1_4", "T_F1_5", "T_F1_6", "T_F1_7", "T_F1_8", "T_F1_9", "T_F1_10")
...
variable_titles <- c(
  ...
  "T_F1_2" = "Sending/receiving money to/from other people, remittances",
  "T_F1_3" = "Paying bills, e.g., rent, school fee, airtime",
  "T_F1_4" = "Saving/accumulating or setting aside money",
  "T_F1_5" = "Borrowing money, taking money from somebody for a period of time",
  "T_F1_6" = "Giving/loaning money for a period of time",
  "T_F1_7" = "Buying Insurance",
  "T_F1_8" = "Investing money in a project, product, etc.",
  "T_F1_9" = "Using a payment scheme, when you pay in small portions over a period of time",
  "T_F1_10" = "Buying an asset – e.g., land, livestock, boda-boda, - to help you earn money"
)
