...
aware_df %>%
filter(variable_title == "Unprompted") %>%
  ggplot(aes(x = 2, y = valid.prc, fill = label)) +
  geom_bar(stat = "identity", width = 1) +
  coord_polar(theta = "y") +
  xlim(0.5, 2.5) +  # Adjust xlim to create the donut hole
  geom_text(aes(label = label_text), position = position_stack(vjust = 0.5)) +
  theme_void() +  # Remove background and axes
  theme(legend.position = "none") +
  facet_wrap(~ variable_title) +  # Facet by variable_title
...
aware_df %>%
filter(variable_title == "Prompted") %>%
  ggplot(aes(x = 2, y = valid.prc, fill = label)) +
  geom_bar(stat = "identity", width = 1) +
  coord_polar(theta = "y") +
  xlim(0.5, 2.5) +  # Adjust xlim to create the donut hole
...
::: {.note}
<span class="info-icon">ℹ️</span>
Only about **72,000** youth read the comic every single day.
:::
...
### Maria kim, Malkia, Charlie Pele, Shujaaz Biz

::: {.note}
<span class="info-icon">ℹ️</span>
Only about **10,000** youth use Maria Kim's Meta pages ever single day.
:::
...
# List of variables to process
variables <- c("T_Q3_6_16", "T_Q3_6_13", "T_Q3_6_14","T_Q3_6_15" )
...
::: {.note}
<span class="info-icon">ℹ️</span>
About **19,000** youth watch STRA at once a week.
:::
...
::: {.note}
<span class="info-icon">ℹ️</span>
Shujaaz Kenya has at least 8,000 daily users in Facebook and YouTube.
:::
...
::: {.note}
<span class="info-icon">ℹ️</span>
Approximately, there are no daily users of of the SMS.
:::
...
::: {.note}
<span class="info-icon">ℹ️</span>
Approximately, over **6,000** youth use DJB's Twitter, Instagram and WhatsApp every day. Over **14,000** use all DJB's platforms once a week.
:::
