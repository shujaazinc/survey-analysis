...
# HIV knowledge, prevention, and management
...
variables <- c("T_HIV1_1", "T_HIV1_2", "T_HIV1_3", "T_HIV1_4", "T_HIV1_5", "T_HIV1_6", "T_HIV1_7", "T_HIV1_8", "T_HIV1_9", "T_HIV1_10", "T_HIV1_11", "T_HIV1_12", "T_HIV1_13", "T_HIV1_14", "T_HIV1_15", "T_HIV2_1", "T_HIV2_2")



# Mapping variable names to readable titles
variable_titles <- c(
  "T_HIV1_1" = "Coughing and sneezing can spread HIV",
  "T_HIV1_2" = "A person can get HIV by sharing a glass of water or food with someone who has HIV",
  "T_HIV1_3" = "Withdrawal prevents a woman from getting HIV during sex",
  "T_HIV1_4" = "Having only one sexual partner reduces the risk of getting HIV",
  "T_HIV1_5" = "Showering or washing yourself after sex keeps a person from getting HIV",
  "T_HIV1_6" = "A women infected with HIV can have a healthy child",
  "T_HIV1_7" = "People infected with HIV quickly show noticeable signs of sickness",
  "T_HIV1_8" = "There is a vaccine that can stop adults from getting HIV",
  "T_HIV1_9" = "People can get HIV from deep kissing",
  "T_HIV1_10" = "A healthy-looking person can have HIV",
  "T_HIV1_11" = "HIV transmission can be reduced by using a condom every time one has sex",
  "T_HIV1_12" = "A person can get HIV from a mosquito bite",
  "T_HIV1_13" = "HIV can be transmitted from a mother to a baby during pregnancy, delivery, or breastfeeding",
  "T_HIV1_14" = "A woman cannot get HIV if she has sex during her period",
  "T_HIV1_15" = "Taking a test for HIV one week after having sex will tell a person if she or he has HIV",
  "T_HIV2_1" = "There is a medication called PrEP, which can help an HIV-positive person to not infect their sexual partners in consensual sex",
  "T_HIV2_2" = "There is treatment that can help stop getting HIV after a person had unplanned or forced sex"
)
...
rename("Question" = variable_title) |>
gt() %>%
tab_header(
    title = "Percentage"
  )%>%
...
# Mapping variable names to readable titles
variable_titles <- c("HIV6" = "Testing post exposure")
...
pivot_wider(names_from = pop, values_from = valid.prc) |>
rename("Testing likelihood" = label) |>
gt() %>%
tab_header(
    title = "Percentage"
  )%>%
