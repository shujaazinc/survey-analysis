...
# Mapping variable names to readable titles
variable_titles <- c("FP21" = "Pregancy & STI prevention discussion")
...
select(label, valid.prc, pop) |>
pivot_wider(names_from = pop, values_from = valid.prc) |>
rename("Ease of discussion " = label) |>
gt() %>%
tab_header(
    title = "Percentage"
  )%>%
...
# List of variables to process
variables <- c("protection")



# Mapping variable names to readable titles
variable_titles <- c("protection" = "Use of protection (Condoms)")
...
select(label, valid.prc, pop) |>
pivot_wider(names_from = pop, values_from = valid.prc) |>
rename("Use of protection" = label) |>
gt() %>%
tab_header(
    title = "Percentage"
  )%>%
